...
-- 2. 权限表数据
INSERT INTO permission (permission_name, permission_key, parent_id, menu_type, path, component, permission_sort, icon, visible) VALUES
-- 系统管理
(1, '系统管理', 'system', 0, 'M', '/system', '', 1, 'system', '0'),
(2, '用户管理', 'system:user', 1, 'C', '/system/user', 'system/user/index', 1, 'user', '0'),
(3, '角色管理', 'system:role', 1, 'C', '/system/role', 'system/role/index', 2, 'role', '0'),
(4, '权限管理', 'system:permission', 1, 'C', '/system/permission', 'system/permission/index', 3, 'permission', '0'),
(5, '日志管理', 'system:log', 1, 'C', '/system/log', 'system/log/index', 4, 'log', '0'),
-- 首页管理
(10, '首页管理', 'home', 0, 'M', '/home', '', 2, 'home', '0'),
(11, 'Banner管理', 'home:banner', 10, 'C', '/home/banner', 'home/banner/index', 1, 'banner', '0'),
(12, '引言管理', 'home:introduction', 10, 'C', '/home/introduction', 'home/introduction/index', 2, 'introduction', '0'),
(13, '置顶项目', 'home:featured', 10, 'C', '/home/featured', 'home/featured/index', 3, 'featured', '0'),
(14, '页脚设置', 'home:footer', 10, 'C', '/home/footer', 'home/footer/index', 4, 'footer', '0'),
(15, '友情链接', 'home:link', 10, 'C', '/home/link', 'home/link/index', 5, 'link', '0'),
-- 清单管理
(20, '清单管理', 'catalog', 0, 'M', '/catalog', '', 3, 'catalog', '0'),
(21, '项目分类', 'catalog:category', 20, 'C', '/catalog/category', 'catalog/category/index', 1, 'category', '0'),
(22, '非遗项目', 'catalog:project', 20, 'C', '/catalog/project', 'catalog/project/index', 2, 'project', '0'),
(23, '传承人', 'catalog:inheritor', 20, 'C', '/catalog/inheritor', 'catalog/inheritor/index', 3, 'inheritor', '0'),
-- 资源管理
(30, '资源管理', 'resource', 0, 'M', '/resource', '', 4, 'resource', '0'),
(31, '影集管理', 'resource:album', 30, 'C', '/resource/album', 'resource/album/index', 1, 'album', '0'),
(32, '音乐管理', 'resource:music', 30, 'C', '/resource/music', 'resource/music/index', 2, 'music', '0'),
(33, '视频管理', 'resource:video', 30, 'C', '/resource/video', 'resource/video/index', 3, 'video', '0'),
-- 学术管理
(40, '学术管理', 'academic', 0, 'M', '/academic', '', 5, 'academic', '0'),
(41, '文章管理', 'academic:article', 40, 'C', '/academic/article', 'academic/article/index', 1, 'article', '0'),
(42, '访谈管理', 'academic:interview', 40, 'C', '/academic/interview', 'academic/interview/index', 2, 'interview', '0'),
(43, '课程管理', 'academic:course', 40, 'C', '/academic/course', 'academic/course/index', 3, 'course', '0'),
-- 系统设置
(50, '系统设置', 'config', 0, 'M', '/config', '', 6, 'config', '0'),
(51, '水印设置', 'config:watermark', 50, 'C', '/config/watermark', 'config/watermark/index', 1, 'watermark', '0'),
(52, '系统参数', 'config:system', 50, 'C', '/config/system', 'config/system/index', 2, 'system', '0');
...
-- 4. 用户表数据
INSERT INTO user (username, password, real_name, avatar, email, phone, role_id, status) VALUES
('editor', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '张编辑', '/static/avatar/avatar1.png', 'editor@example.com', '13800138001', 2, 1),
('operator', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '李录入', '/static/avatar/avatar2.png', 'operator@example.com', '13800138002', 3, 1),
('analyst', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '王分析', '/static/avatar/avatar3.png', 'analyst@example.com', '13800138003', 4, 1),
('visitor', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '游客用户', '/static/avatar/avatar4.png', 'visitor@example.com', '13800138004', 5, 1);

-- 5. 登录日志表数据
INSERT INTO login_log (user_id, username, login_ip, login_location, browser, os, status, msg) VALUES
(1, 'admin', '192.168.1.100', '青海省西宁市', 'Chrome', 'Windows 10', 0, '登录成功'),
(2, 'editor', '192.168.1.101', '青海省西宁市', 'Firefox', 'Windows 10', 0, '登录成功'),
(3, 'operator', '192.168.1.102', '青海省西宁市', 'Edge', 'Windows 10', 0, '登录成功'),
(1, 'admin', '192.168.1.100', '青海省西宁市', 'Chrome', 'Windows 10', 0, '登录成功'),
(4, 'analyst', '192.168.1.103', '青海省西宁市', 'Safari', 'macOS', 0, '登录成功'),
(5, 'visitor', '192.168.1.104', '青海省西宁市', 'Chrome', 'Android', 1, '密码错误');
...
(1, 'admin', '用户管理', '新增', '新增用户：editor', '/api/system/user', 'POST', '{"username":"editor","role_id":2}', '{"code":200,"msg":"操作成功"}', '192.168.1.100'),
(1, 'admin', '角色管理', '修改', '修改角色：编辑员', '/api/system/role', 'PUT', '{"id":2,"role_name":"编辑员"}', '{"code":200,"msg":"操作成功"}', '192.168.1.100'),
(2, 'editor', '非遗项目', '新增', '新增项目：热贡艺术', '/api/catalog/project', 'POST', '{"project_name":"热贡艺术"}', '{"code":200,"msg":"操作成功"}', '192.168.1.101'),
(3, 'operator', '传承人', '新增', '新增传承人：才让多杰', '/api/catalog/inheritor', 'POST', '{"inheritor_name":"才让多杰"}', '{"code":200,"msg":"操作成功"}', '192.168.1.102'),
(2, 'editor', 'Banner管理', '修改', '修改首页Banner', '/api/home/banner', 'PUT', '{"id":1,"title":"青海非遗"}', '{"code":200,"msg":"操作成功"}', '192.168.1.101');
